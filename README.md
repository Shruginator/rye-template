...
1. Rename the root directory `rye-template` and `src/rye_template/` to match your
desired project name.
2. Adjust project description in `pyproject.toml` and `README.md`.
3. Run `rye sync --update-all` in the shell to set up the project's virtual environment. (Find Rye
installation instructions on its website [Rye](https://rye.astral.sh/).)
...
|-|-|-|
|`EXAMPLE_ENV_VAR`|Only an example variable.|`None`|
